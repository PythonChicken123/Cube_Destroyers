...
required_libraries = ['pygame', 'numpy', 'asyncio']
...
async def perform_explosion(explosion_frame_index, explosion_frame_counter, special_egg_destroyed, explosion_frames, explosion_rect, explosion_sound, explosion_frame_delay):
...
async def handle_explosions(explosion_frame_index, explosion_frame_counter, special_egg_destroyed, explosion_frames, explosion_rect, explosion_sound, explosion_frame_delay):
    if special_egg_destroyed and 0 <= explosion_frame_index < len(explosion_frames):
        ...
        explosion_frame_index, explosion_frame_counter, special_egg_destroyed = await perform_explosion(
            ...
            explosion_frames, explosion_rect, explosion_sound, explosion_frame_delay
        )
...
async def play_game():
    ...
    explosion_frames: list[Surface | SurfaceType] = [
        pygame.transform.scale(pygame.image.load(os.path.join('', 'image', 'explosion2.gif')), (160, 160)),
        pygame.transform.scale(pygame.image.load(os.path.join('', 'image', 'explosion1.gif')), (160, 160))]
    ...
    while running:
        ...
        explosion_frame_index, explosion_frame_counter, special_egg_destroyed = await handle_explosions(
            explosion_frame_index, explosion_frame_counter, special_egg_destroyed, explosion_frames, explosion_rect, explosion_sound, explosion_frame_delay
        )
